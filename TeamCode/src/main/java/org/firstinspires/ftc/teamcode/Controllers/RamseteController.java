...
public class RamseteController {
     ...
     */
    public void setTolerance(Pose poseTolerance) {
        m_poseTolerance = poseTolerance.ftcLibTrans();
    }
    ...
    public ChassisSpeeds calculate(Pose currentPose,
                                   Pose poseRef,
                                   double linearVelocityRefMeters,
                                   double angularVelocityRefRadiansPerSecond) {
        m_poseError = poseRef.ftcLibTrans().relativeTo(currentPose.ftcLibTrans());
     ...
     */
//    @SuppressWarnings("LocalVariableName")
//    public ChassisSpeeds calculate(Pose currentPose, Trajectory.State desiredState) {
//        return calculate(currentPose, desiredState,
